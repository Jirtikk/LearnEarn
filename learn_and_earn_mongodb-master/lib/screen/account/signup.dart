        ...
        child: Column(
          children: [
            logsighelper(
                ...
                text2: 'up',
                text3:
                    'Please sign up to get access to a vast range of courses and jobs.'),
            Expanded(
                        ...
                        return AnimatedOpacity(
                          ...
                          child: const Padding(
                            ...
                            child: CircularProgressIndicator(
                              strokeWidth: 6.0,
                              valueColor:
                                  AlwaysStoppedAnimation<Color>(col.pruple),
                            ),
                          ),
                        );
                      }),
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            if (provider.name == '' ||
                              ...
                              provider.notifyListeners();
                            } else if(!provider.passwordController.areAllRulesValidated){
                              AppLayout.showsnakbar(context, 'Password not valid');
                              provider.resetvisi = false;
                              provider.notifyListeners();
                              ...
                              provider.resetvisi = false;
                              provider.notifyListeners();
                            } else if (provider.phone.substring(1) != '0' &&
                                provider.phone.length != 11) {
                              AppLayout.showsnakbar(context,
                                  'Phone No. must start with 0 having 11 digits');
                              provider.resetvisi = false;
                              provider.notifyListeners();
                            } else {
                              ...
                              //   phoneNumber:
                              //       '+92${provider.phone.toString().substring(1)}',
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            if (provider.name == '' ||
                                ...
                                provider.pass == '') {
                              AppLayout.showsnakbar(
                                  context, 'Fill all fields to continue');
                              provider.resetvisi = false;
                              provider.notifyListeners();
                            } else if(!provider.passwordController.areAllRulesValidated){
                              AppLayout.showsnakbar(context, 'Password not valid');
